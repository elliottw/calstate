(function(){
	...
	$(function() {
		var PlannerLayout = Backbone.Marionette.Layout.extend({
		...
		plannerLayout.fall13.show(new App.views.SemesterView({
			// set collection: some PlannedCourse collection
		}));

		plannerLayout.spr14.show(new App.views.SemesterView({
			// set collection: some PlannedCourse collection
		}));

		plannerLayout.fall14.show(new App.views.SemesterView({
			// set collection: some PlannedCourse collection
		}));

		plannerLayout.spr15.show(new App.views.SemesterView({
			// set collection: some PlannedCourse collection
		}));
